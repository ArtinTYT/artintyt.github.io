...
atEvery.prototype._init = function () {
    ...
    color1 = typeof (color1) === "undefined" || color1 === '' ? "RGBA(119, 126, 236, 0.14)" : color1;
    color2 = typeof (color2) === "undefined" || color2 === '' ? "#f0dfe7" : color2;
    color3 = typeof (color3) === "undefined" || color3 === '' ? "black" : color3;
    ...
    saveContent.onclick = function save() {
        ...
        let atAvatar = typeof (currentUser.attributes.img) === "undefined" ? "/img/avatar.webp" : currentUser.attributes.img;
        // alert(deFaultavatar);
...
atEvery.prototype.seeContent = function (pageNum, option) {
    ...
    query.find().then(function (shuoContent) {
        ...
        shuoContent.forEach(function (atContent) {
            ...
            shuoAvatar = typeof (shuoAvatar) === "undefined" ? "/img/avatar.webp" : shuoAvatar;
            let currentUser = AV.User.current();
        ...
        if (shuoNum === 0 && pageNum === 0) {
            originString = "<ul class=\"cbp_tmtimeline\" id=\"maina\"><li><span class=\"shuoshuo_author_img\"><img src=\"/img/avatar.webp\" class=\"artitalk_avatar gallery-group-img\" width=\"48\" height=\"48\"></span><span class=\"cbp_tmlabel\"><p>" + text24 + "</p><p class=\"shuoshuo_time\"><span style=\"\"> Artin提醒</span><span style=\"float:right;\"><svg t=\"1591350675688\"  viewBox=\"0 0 1025 1024\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" p-id=\"28653\" width=\"10\" height=\"10\" style=\"display: inline\"></svg> 2020-04-10 20:35:25</span></p></span></li></ul>";
        }
    ...
    atEvery.prototype.saveComment = function (id, option) {
        ...
        if (currentUser) {
            let adminAvatar = typeof (currentUser.attributes.img) === "undefined" ? "/img/avatar.webp" : currentUser.attributes.img;
